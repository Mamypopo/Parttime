...
<div class="text-center pt-24 pb-5">
  ...
  <div class="max-w-xl lg:max-w-2xl mx-auto -pt-1 space-y-2 animate-fade-in-up">
    <p class="text-sm lg:text-base text-white/80">Find the perfect part-time opportunity that matches your skills and schedule</p>
  </div>
</div>
...
<div class="space-y-4">
        ...
        <div class="bg-gray-50 p-2 rounded-[15px] border border-gray-200">
          <div class="flex flex-wrap gap-1.5">
            <label v-for="skill in availableSkills" 
                   ...
                   :class="form.skills.includes(skill) ? 'bg-purple-100 border-purple-300' : 'bg-white border-gray-200'"
            >
              <input type="checkbox" 
                     :value="skill" 
                     v-model="form.skills"
  ...
  <div
        class="max-w-4xl lg:max-w-5xl mx-auto px-4 lg:px-8 flex justify-between text-gray-600"
      >        <div>
          Lorem ipsum dolor sit <span class="text-[#CDE45F]">Lorem ipsum</span> & <span class="text-[#CDE45F]">Something</span> Lorem ipsum
        </div>

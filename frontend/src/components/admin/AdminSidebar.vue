<template>
  <div class="flex flex-col min-h-screen bg-gray-50">
    ...
    <div v-if="!isMobile" 
      class="transition-all duration-300 h-screen fixed bg-white border-r" 
...
<button v-if="isCollapsed && !isTablet" 
    @click="toggleSidebar"
    class="absolute -right-10 top-4 bg-white hover:bg-gray-100 p-2 rounded-full shadow-md"
...
<NotificationsPanel :is-collapsed="isCollapsed" />
      ...
      <!-- Admin Profile -->
      <div class="absolute bottom-0 left-0 bg-emerald-100 p-4"
        :class="[isCollapsed ? 'w-16' : 'w-64']"
      >
    ...
    <nav v-else class="fixed bottom-0 left-0 right-0 bg-white border-t px-4 py-2">
...
/* Optional: Add animation for bell icon */

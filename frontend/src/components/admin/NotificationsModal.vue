    ...
    <HeadlessDialog as="div" @close="closeModal" class="relative z-50">
      ...
      <div class="fixed inset-0 overflow-y-auto ">
        <div class="flex min-h-full items-center justify-center p-4 ">
          ...
          >
      <HeadlessDialogPanel class="w-full max-w-4xl bg-white rounded-xl shadow-xl  overflow-hidden"> 
              <!-- Header -->
              <div class="flex justify-between items-center p-6  bg-gradient-to-r from-[#6ED7D1] to-[#9899ee] border-b">
               ...
               อ่านทั้งหมด
                  ...
                  <button @click="closeModal" class="text-[#3A3A49] hover:text-[#2b2b4d]  transition-colors duration-200">
               ...
               <p>ไม่มีการแจ้งเตือน</p> 
                ...
                >
                  <div class="flex gap-4">
                    <div class="mt-1">
                      <span class="flex h-10 w-10 items-center justify-center rounded-full shadow-sm" 
  ...
  formatTime(date) {
   ...
   async markAllAsRead() {
      try {
        ...
        // อัพเดท UI หลังจาก mark all as read สำเร็จ
